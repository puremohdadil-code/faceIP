...
from .report import render_csv, render_diff, render_report, render_with_ruby
...
def main() -> None:
    ...
    service = SentinelService(data_dir, native_root=args.root / ".build" / "native")
    ...
    if args.command == "inventory":
        ...
        ruby_report = render_with_ruby(snapshot, args.root / "modules" / "ruby_report" / "lib" / "report.rb")
        print(ruby_report if ruby_report else render_report(snapshot), end="" if ruby_report else "")
